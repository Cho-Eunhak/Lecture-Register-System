	...
	public void cancel(VPersonalInfo vPersonalInfo, String k) {
		...
		try {
			...
			vGangjwas = new Vector<VGangjwa>();
			 ...
			 FileReader file = new FileReader("sincheongdata/"+vPersonalInfo.id+"sugangsincheong.txt");
			...
			File a = new File("sincheongdata/"+vPersonalInfo.id+"sugangsincheong.txt");
